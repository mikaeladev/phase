  ...
  return (
    <main className="flex min-h-screen w-full flex-col">
      ...
      <div className="grid h-[calc(100vh-4rem-1px)]">
        <div className="animate-in fade-in-0 fill-mode-both absolute place-self-center text-center duration-1000 [animation-delay:2s]">
          <h1 className="text-[9rem] leading-none font-black tracking-tighter">
            404
          </h1>
          <p className="text-5xl font-extrabold tracking-tighter">Not Found</p>
        </div>
        <Moon className="animate-moon-shrink h-72 w-72 origin-center place-self-center sm:h-80 sm:w-80 md:h-96 md:w-96" />
        <svg
          className="animate-moon-twinkle absolute h-0 w-0 origin-center place-self-center"
          width="112"
          height="113"
          viewBox="0 0 112 113"
          fill="none"
